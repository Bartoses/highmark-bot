...
export function formatResponsePlanInstruction(plan, client) {
  const lines = [];
...
// ─────────────────────────────────────────────────────────────────────────────
export function buildLeadCapturePrompt(client, inferredGoal) {
...
export async function checkAvailabilityIfNeeded(message, convo, client) {
...
// ─────────────────────────────────────────────────────────────────────────────
export async function buildTourMenu(client, season, dateStr) {
...
export function formatMenuInstruction(client, options, dateStr) {
...
export function isAllUnavailable(options, dateStr) {
...
// ─────────────────────────────────────────────────────────────────────────────
export async function getConversation(fromNumber, toNumber) {
...
// ─────────────────────────────────────────────────────────────────────────────
export async function getClaudeReply(convo, client, season, knowledgeContext, extraInstruction, maxLength = 320) {
...
app.get(   "/portal/api/operations/intelligence",             requirePortalAuth, (req, res) => handleOperationsIntelligence(req, res, supabase, crmSupabase));
app.get(   "/portal/api/operations/ai-insights",              requirePortalAuth, (req, res) => handleOperationsAiInsights(req, res, supabase, crmSupabase, anthropic));
app.post(  "/portal/api/operations/ai-insights/refresh",      requirePortalAuth, (req, res) => handleOperationsAiInsights(req, res, supabase, crmSupabase, anthropic));
